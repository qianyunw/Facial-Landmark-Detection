    ...
    namespace core {
        ...
        */
        ...
        private:
            ...
            void readPixelIntensities(const Eigen::AffineCompact3f &shapeToShape, const Eigen::AffineCompact3f &shapeToImage, const Shape &s, const Image &i, PixelIntensities &intensities) const;
